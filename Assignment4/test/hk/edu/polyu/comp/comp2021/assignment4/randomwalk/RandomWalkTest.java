...
public class RandomWalkTest {
    ...
    @Test
    public void testSetDegree02() {
        n2.setDegree();
        assertEquals(4, n2.getDegree());
    }
    ...
    @Test
    public void testTransitionProbability02() {
        assert (Math.abs(n1.transitionProbability(n6) - 0.2857142857142857) < DELTA);
    }

    @Test
    public void testTransitionProbability03() {
        assert (Math.abs(n2.transitionProbability(n5) - 0) < DELTA);
    }
    ...
    @Test
    public void testOverlapping02() {
        HashSet<Node> h = new HashSet<Node>(Arrays.asList(n1, n2, n4, n6, n5));
        assertTrue(h.equals(r1.nodeOverlapping(r2)));
    }
